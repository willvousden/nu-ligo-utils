...
# FIXME: Hardcoded lalsim max amp pN orders until accessible by SWIG
...
def get_inj_info(inj, event=0, ifos=['H1','L1','V1'], era='advanced', intended_flow=30):
  ...
  chirptime =  seglen_fudgefactor * lalsim.SimInspiralTaylorF2ReducedSpinChirpTime(flow, mass1, mass2, chi, phase_order)
  ...
  hp,hc = lalsim.SimInspiralChooseTDWaveform(
      event.coa_phase,
      1.0/srate,
      event.mass1 * lalsim.lal.LAL_MSUN_SI,
      event.mass2 * lalsim.lal.LAL_MSUN_SI,
